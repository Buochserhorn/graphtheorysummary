\documentclass[10pt, fleqn, a4paper, landscape]{article}
\usepackage{listings}
\usepackage{color}
\usepackage{datetime}
...
% \addtocounter{thm}{3} if one wants to add to counter, if an example from lectture notes is skipped, to maintain the same numbering, insert in right place
